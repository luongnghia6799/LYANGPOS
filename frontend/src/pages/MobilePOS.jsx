                ...
                {isMenuOpen && (
                    <>
                        ...
                        <m.div
                            ...
                            className="fixed top-0 left-0 bottom-0 w-[80%] max-w-[300px] bg-white dark:bg-slate-900 z-50 shadow-2xl p-6"
                        >
                            <div className="text-xl font-black text-primary uppercase mb-8">Menu</div>
                            <div className="space-y-4">
                                {menuItems.map((item, idx) => (
                                    <button
                                        ...
                                        className="flex items-center gap-3 w-full p-3 rounded-xl hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors font-bold text-gray-700 dark:text-gray-200"
                                    >
